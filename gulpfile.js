...
gulp.task(
  "sass:bs",
  sassCompiler(
    "public/assets/vendor_assets/css/bootstrap/bootstrap.scss",
    "public/assets/vendor_assets/css/bootstrap/"
  )
);
...
gulp.task(
  "sass:theme",
  sassCompiler("public/assets/theme_assets/sass/style.scss", "public/assets")
);
...
gulp.task(
  ...
  gulp.series("sass:theme", function () {
    gulp.watch(
      "public/assets/theme_assets/sass/**/*",
      gulp.series("sass:theme")
    );
    gulp.watch(
      "public/assets/vendor_assets/css/bootstrap/*.scss",
      gulp.series("sass:bs")
    );
...
gulp.task("rtl", function (done) {
  var bootstrap = gulpfilter(
      "public/assets/vendor_assets/css/bootstrap/bootstrap.css",
      { restore: true }
    ),
